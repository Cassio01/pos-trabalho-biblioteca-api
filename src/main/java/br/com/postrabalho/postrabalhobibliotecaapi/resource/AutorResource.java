...
import br.com.postrabalho.postrabalhobibliotecaapi.service.AutorService;
...
public class AutorResource {
	...
	public ResponseEntity<Autor> inserir(@RequestBody @Valid Autor autor) {
		...
		URI uri = ServletUriComponentsBuilder.fromCurrentRequest().path("/{id}").buildAndExpand(autorCadastrado.getId())
				.toUri();
	...
	public ResponseEntity<Autor> pesquisarPorId(@PathVariable("id") Long id) {
		...
		Autor autor = this.service.pesquisaPorId(id);
