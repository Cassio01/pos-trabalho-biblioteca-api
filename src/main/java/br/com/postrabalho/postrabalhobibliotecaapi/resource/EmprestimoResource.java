...
import br.com.postrabalho.postrabalhobibliotecaapi.service.EmprestimoService;
...
public class EmprestimoResource {
	...
	@PostMapping
	public ResponseEntity<Emprestimo> inserir(
		...
		URI uri = ServletUriComponentsBuilder
				.fromCurrentRequest()
				.path("/{id}")
				.buildAndExpand(emprestimoCadastrado.getId())
				.toUri();
		
		return ResponseEntity.created(uri)
				.body(emprestimoCadastrado);
	}
	...
	@GetMapping("/{id}")
	public ResponseEntity<Emprestimo> pesquisarPorId(
			@PathVariable("id") Long id) {
		
		Emprestimo emprestimo = this.service.pesquisarPorId(id);
